    ...
    public class ChartDAO
    {
        ...
        public List<ChartModel> Top10Loai()
        {
            ...
            foreach (var item in db.Loais.Where(i => i.Flag == true).ToList())
            {
                ...
                model.SoLuong = 0;
                foreach (var item1 in db.ChiTietHoaDons.Where(i => i.HoaDon.TinhTrangHoaDon == "Đã Thanh Toán" && i.SanPhams.LoaiId == item.MaLoai).ToList())
                {
        ...
        public List<ChartModel> Top10NSX()
        {
            ...
            foreach (var item in db.NSXs.Where(i => i.flag == true).ToList())
            {
                ...
                model.ID = item.MaNSX;
                model.SoLuong = 0;
                foreach (var item1 in db.ChiTietHoaDons.Where(i => i.HoaDon.TinhTrangHoaDon == "Đã Thanh Toán" && i.SanPhams.NSXId == item.MaNSX).ToList())
                {
                    model.SoLuong = model.SoLuong + item1.SoLuong;
                }
                list.Add(model);
        ...
        public List<ChartModel> Top10SanPham()
        {
            ...
            foreach (var item in db.SanPhams.Where(i=>i.Flag==true).ToList())
            {
                ...
                model.ID = item.MaSP;
                model.SoLuong = 0;
                foreach (var item1 in db.ChiTietHoaDons.Where(i=>i.HoaDon.TinhTrangHoaDon == "Đã Thanh Toán" && i.SanPhamId == item.MaSP).ToList())
                {
                    model.SoLuong = model.SoLuong + item1.SoLuong;
                }
                list.Add(model);
        ...
        public List<string> GetListTop10SP()
        {
            ...
            foreach (var item in Top10SanPham())
            {
                list.Add(db.SanPhams.Find(item.ID).TenSP);
            }
            return list;
        }
        public List<int> GetSLTheoNSX()
        {
            ...
            foreach (var item in db.NSXs.Where(i=>i.flag==true).ToList())
            {
                ...
                int SoLuong = db.SanPhams.Where(i => i.Flag == true && i.NSXId == item.MaNSX).Count();
                listSL.Add(SoLuong);
        ...
        public List<int> GetSLTheoLoai()
        {
            ...
            foreach (var item in db.Loais.Where(i => i.Flag == true).ToList())
            {
                ...
                int SoLuong = db.SanPhams.Where(i => i.Flag == true && i.LoaiId == item.MaLoai).Count();
                listSL.Add(SoLuong);
